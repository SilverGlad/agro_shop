...
import 'components/my_products_grid_tile.dart';
import 'components/my_products_list_tile.dart';
import 'components/search_dialog.dart';


class MyProductsScreen extends StatelessWidget {
  MyProductsScreen(this.filterCategory, this.nameCategory);
                ...
                builder: (_, productManager, __){
                  if(productManager.search.isEmpty){
                    if(filterCategory.isEmpty){
                      return const Text('Meus produtos',
                ...
                Consumer<ProductManager>(
                  builder: (_, productManager, __){
                    ...
                    return GridView.builder(
                        ...
                        itemBuilder: (_,index){
                          productManager.categoryfilt = filterCategory;
                          return MyProductGridTile(filteredProducts[index]);
                ...
                Consumer<ProductManager>(
                  builder: (_, productManager, __){
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (_,index){
                          productManager.categoryfilt = filterCategory;
                          return MyProductListTile(filteredProducts[index]);
